...
CATEGORIES = [
    {"id": "emergency_general", "label": "응급의료 일반", "limit": 15,
     "topics": [
         {"query_national": "응급의료 정책 OR 응급의료기관 OR 응급실 과밀화 OR 권역외상센터",
          "query_daegu": "대구 응급의료 OR 대구 응급실 OR 대구 응급의료기관 OR 대구 권역외상센터"},
     ]},
    {"id": "er_runaround", "label": "응급실 뺑뺑이", "limit": 15,
     "topics": [
    ...
    {"id": "disaster", "label": "재난의료", "limit": 15,
     "topics": [
         {"query_national": "재난의료", "query_daegu": "대구 재난의료"},
     ]},
    {"id": "pediatric", "label": "소아응급의료", "limit": 15,
     "topics": [
...
MAX_ITEMS_PER_QUERY = 8   # 전국/대구 검색어 각각에서 가져올 최대 건수
